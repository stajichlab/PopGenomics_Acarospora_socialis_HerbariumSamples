...
INDIR=/bigdata/stajichlab/shared/projects/Lichen/Acarospora_socialis_HerbariumSamples/genome/socialis.reference.sort
OUTDIR=annotate
...
do
    ...
    funannotate predict --cpus $CPU --keep_no_stops --SeqCenter $SEQCENTER --busco_db $BUSCO --optimize_augustus \
        ...
        -i $INDIR/$BASE.mask.fasta --name $LOCUSTAG --protein_evidence lib/JALDZA01.1.fsa_aa \
